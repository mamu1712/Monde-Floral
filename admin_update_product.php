...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE tbl_products SET name = '$name', details = '$details', price = '$price' WHERE id = '$update_p_id'") or die('query failed');
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         mysqli_query($conn, "UPDATE tbl_products SET image = '$image' WHERE id = '$update_p_id'") or die('query failed');
...
<head>
   ...
   <title>Monde Floral | Update Product</title>
