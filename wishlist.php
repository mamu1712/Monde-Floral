...
<head>
    ...
    <title>Monde Floral | Wishlist</title>
...
<body>
    ...
    <section class="wishlist">
        ...
        <h1 class="title">Poducts Added</h1>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product-grid">
                                <div class="product-image">
                                    <a href="view_page.php?pid=<?php echo $fetch_wishlist['pid']; ?>" class="image">
                                ...
                                <div class="product-content">
                                    <h3 class="title"><a href="view_page.php?pid=<?php echo $fetch_wishlist['pid']; ?>"><?php echo $fetch_wishlist['name']; ?></a></h3>
